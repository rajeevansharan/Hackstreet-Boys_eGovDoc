...
// Page: Enter The OTP (6 digits) for phone verification.
// Tries POST /auth/verify-phone-otp { phone, otp }.
// If endpoint absent but mock OTP was stored, accepts that.
...
export default function VerifyOTP() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res || !res.ok) {
        // Fallback: accept mock OTP
        const mock = sessionStorage.getItem("egovdoc:mockOtp");
        if (mock && mock === otp) {
